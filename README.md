...
The brief is one widget line above the editor, plus an optional trace under a custom status line. The widget fits the locked goal and Now to the current terminal width. In print/JSON/RPC modes the extension performs no summarization or UI updates.
